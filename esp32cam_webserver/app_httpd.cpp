...
void startCameraServer(){
    ...
    httpd_uri_t moveup_uri = {
        .uri       = "/moveup",
        .method    = HTTP_GET,
        .handler   = move_up_handler,
        .user_ctx  = NULL
    };
    httpd_uri_t moveforward_uri = {
        .uri       = "/moveforward",
        .method    = HTTP_GET,
        .handler   = move_forward_handler,
        .user_ctx  = NULL
    };
    httpd_uri_t movedown_uri = {
        .uri       = "/movedown",
        .method    = HTTP_GET,
        .handler   = move_down_handler,
        .user_ctx  = NULL
    };
    httpd_uri_t moveleft_uri = {
        .uri       = "/moveleft",
        .method    = HTTP_GET,
        .handler   = move_left_handler,
        .user_ctx  = NULL
    };
    httpd_uri_t moveback_uri = {
        .uri       = "/moveback",
        .method    = HTTP_GET,
        .handler   = move_back_handler,
        .user_ctx  = NULL
    };
    httpd_uri_t moveright_uri = {
        .uri       = "/moveright",
        .method    = HTTP_GET,
        .handler   = move_right_handler,
        .user_ctx  = NULL
    };
    httpd_uri_t openclaw_uri = {
        .uri       = "/openclaw",
        .method    = HTTP_GET,
        .handler   = open_claw_handler,
        .user_ctx  = NULL
    };
    httpd_uri_t closeclaw_uri = {
        .uri       = "/closeclaw",
        .method    = HTTP_GET,
        .handler   = close_claw_handler,
        .user_ctx  = NULL
    };
   ...
   httpd_uri_t stream_uri = {
    ...
    if (httpd_start(&camera_httpd, &config) == ESP_OK) {
        ...
        httpd_register_uri_handler(camera_httpd, &moveup_uri);
        httpd_register_uri_handler(camera_httpd, &moveforward_uri);
        httpd_register_uri_handler(camera_httpd, &movedown_uri);
        httpd_register_uri_handler(camera_httpd, &moveleft_uri);
        httpd_register_uri_handler(camera_httpd, &moveback_uri);
        httpd_register_uri_handler(camera_httpd, &moveright_uri);
        httpd_register_uri_handler(camera_httpd, &openclaw_uri);
        httpd_register_uri_handler(camera_httpd, &closeclaw_uri);
    }
